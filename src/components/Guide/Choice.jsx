...
const Choice = () => {
    return (
        <div className='flex flex-col justify-center items-center space-y-3 border-2 rounded-2xl border-gray-200 px-6  text-center transition-all duration-150 hover:-translate-y-1'>
